...
const LocationField = ({
  fcId,
  label,
  value, // Expected to be a JSON string of the location data object or null/empty if no location captured ({ latitude, longitude, accuracy, timestamp, address, isManualEntry })
  onChange,
  required = false,
  disabled = false,
  description,
  ...
  const [locationType, setLocationType] = useState(null); // 'gps' or 'manual'
