...
const ProfileField = ({
  ...
  const handleLocationPress = () => {
    if (onLocationChange) {
      ...
      setTimeout(() => {
        onLocationChange('Current Location: 12.9716° N, 77.5946° E');
      }, 1000);
    }
  };
    ...
    return (
      <View style={styles.fieldContainer}>
        ...
        <View style={styles.fieldValueContainer}>
          ...
          {rightIcon && (
            <Icon name={rightIcon} size={20} color={rightIconColor || COLORS.success} />
          )}
        </View>
      ...
      {isDate ? (
        ...
        >
          ...
          <Text style={value ? styles.locationText : styles.placeholderText}>
            {value || 'Tap to capture current location'}
          </Text>
        </TouchableOpacity>
      ) : isToggle ? (
